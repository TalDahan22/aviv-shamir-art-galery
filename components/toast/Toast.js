...
export default function Toast({ type, message, id }) {
  ...
  return (
    <>
      ...
      {type == "error" && (
        <div className="rounded-md bg-red-100 p-4 m-3">
          <div className="flex">
            <div className="flex-shrink-0">
              <svg
            ...
            <div className="ml-auto pl-3">
              <div className="-mx-1.5 -my-1.5">
                <button
                  ...
                  className="inline-flex bg-red-50 rounded-md p-1.5 text-red-500 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-50 focus:ring-green-600"
                >
                  <span className="sr-only">Dismiss</span>
